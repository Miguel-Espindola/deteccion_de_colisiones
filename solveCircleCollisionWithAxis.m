...
%   Detailed explanation goes here
    switch nargin
        ...
        case 2
            if correction == 1
                correctedVelocity(1) = -1*abs(v(1));
                correctedVelocity(2) = v(2);
            elseif correction == -1
                correctedVelocity = abs(v(1));
            elseif correction == 2
                correctedVelocity(1) = v(1);
                correctedVelocity(2) = -1*abs(v(2));
            elseif correction == -2
                correctedVelocity(1) = v(1);
                correctedVelocity(2) = abs(v(2));
            else
